...
-- Copiando dados para a tabela tarefadb.categoria: ~3 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `tarefa` (
  ...
  CONSTRAINT `FK_tarefa_3` FOREIGN KEY (`fk_categoria_id`) REFERENCES `categoria` (`id`) ON DELETE SET NULL,
  CONSTRAINT `FK_tarefa_4` FOREIGN KEY (`fk_estado_id`) REFERENCES `estado` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Copiando dados para a tabela tarefadb.tarefa: ~5 rows (aproximadamente)
INSERT INTO `tarefa` (`id`, `nome`, `data_expiracao`, `data_conclusao`, `descricao`, `fk_usuario_id`, `fk_categoria_id`, `fk_estado_id`) VALUES
	(49, 'Trabalho de Banco de dados', '2025-11-20', NULL, 'Lista de exercícios no teams', 8, 19, 1),
	(50, 'Ir ao mercado', '2025-11-11', NULL, 'Comprar farinha, feijão e arroz', 8, 18, 1),
	(51, 'Prova de matemática', '2025-11-05', '2025-11-10', '', 8, 19, 2),
	(52, 'Pesquisar sobre sessões do PHP', '2025-11-11', '2025-11-10', '', 8, 20, 2),
	(53, 'sadoaspidaspoidhisapohd', NULL, '2025-11-10', 'asdasdsadadsa', 8, 19, 2);
...
INSERT INTO `usuario` (`id`, `nome`, `senha`, `email`) VALUES
	(8, 'John', '$2y$10$2DmXOd7mJ1r9Kgwh.oICWe2Qr5s9DgWqdjSEKvPTzzAGuIGx9RU4K', 'john@gmail.com');
